...
const NoteCard = ({note,setNotes}) => {
  ...
  className = "card bg-base-100 hover:shadow-lg transition-all duration-200 border-t-4 border-solid border-cyan-900">
  ...
  <div className="card-body">
    ...
    <div className="card-actions justify-between items-center mt-4">
      ...
      <button className='btn btn-ghost btn-xs text-error' onClick={(e) => handleDelete(e,note._id)}><TrashIcon className='size-4'></TrashIcon></button>
    </div>
